...
console.log("Loading NextAuth route (MySQL integrated)");
      ...
      try {
        ...
        if (whitelistRows.length > 0) {
          ...
          await connection.execute(
            ...
            [user.name, user.email, 'RnD'] // Default role
          );

          // Opsional: Hapus dari whitelist setelah berhasil daftar 
          // (atau biarkan sebagai history, tapi kita pilih hapus supaya bersih)
        ...
        // 3. Jika tidak ada di keduanya, tolak akses
